package snailvoyager.spring.batch.part2;
        ...
        return stepBuilderFactory.get("shareStep2")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    log.info("jobKey : {}, stepKey : {}",
                            jobExecutionContext.getString("jobKey", "emptyJobKey"),     //step 간에 공유
                            stepExecutionContext.getString("stepKey", "emptyStepKey")); //한 step 내에서만 공유
